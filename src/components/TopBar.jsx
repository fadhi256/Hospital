      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2 items-center">
            ...
            <ContactItem icon={<FaWhatsapp />} text={contactDetails.whatsapp} href={`httpsa://wa.me/${contactDetails.whatsapp}`} />
...
const ContactItem = ({ icon, text, href }) => (
  <a href={href} className="flex items-center gap-2 hover:text-emerald-400 transition-colors">
    {React.cloneElement(icon, { className: 'text-emerald-500' })} {/* Colors the icon */}
    <span>{text}</span>
  </a>
);
